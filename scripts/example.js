...
const dockerEnv = Object.entries(env)
  ...
  .join(" ")
exec(
  `docker compose -f docker/docker-compose.yml run ${dockerEnv} -e PORT=8080 -p 8080:8080 --rm alpine 'cd ./examples/${example} && yarn install && (yarn start || true)'; yarn install`,
)
