...
JsMetricTags::JsMetricTags(sw::CallbackInfo const info)
    : sw::Class<JsMetricTags, MetricTags>(new MetricTags(info.arg<size_t>(0)), info) {}
...
Napi::Value JsMetricTags::add(sw::CallbackInfo const info) {
