...
export type TriggerTrace = (typeof TriggerTrace)[keyof typeof TriggerTrace]

export function parseTraceOptions(header: string, logger: DiagLogger = diag): TraceOptions {
